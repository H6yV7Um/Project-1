...
export const ACTION_TYPES = keyMirror({
    ...
    // 显示软键盘
    LAYOUT_DD_SHOW_KEYBOARD : null,
    // 隐藏软键盘
    LAYOUT_DD_HIDE_KEYBOARD : null,
    // 显示模态层
    LAYOUT_DD_SHOW_MODAL : null,
    // 隐藏模态层
    LAYOUT_DD_HIDE_MODAL : null
});
        ...
        dispatch({
            [CALL_API] : {
                ...
                success : data => {
                    ...
                    dd.config({
                        // 微应用ID
                        agentId : CONFIG.GET_DD_AGENT_ID(),
                        // 企业ID
                        corpId : CONFIG.DD_CORP_ID,
                        // 生成签名的时间戳
...
export const showKeyboard = () => {
    return {
        type : ACTION_TYPES.LAYOUT_DD_SHOW_KEYBOARD
    }
}
...
export const hideKeyboard = () => {
    return {
        type : ACTION_TYPES.LAYOUT_DD_HIDE_KEYBOARD
    }
}
...
export const showModal = () => {
    return {
        type : ACTION_TYPES.LAYOUT_DD_SHOW_MODAL
    }
}
...
export const hideModal = () => {
    return {
        type : ACTION_TYPES.LAYOUT_DD_HIDE_MODAL
    }
}