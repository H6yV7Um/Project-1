...
export default (state = initialState, action) => {
    ...
    switch(action.type)
    {
        ...
        // 显示软键盘
        case ACTION_TYPES.LAYOUT_DD_SHOW_KEYBOARD:
            newState.isShowKeyboard = true;
            break;

        // 隐藏软键盘
        case ACTION_TYPES.LAYOUT_DD_HIDE_KEYBOARD:
            newState.isShowKeyboard = false;
            break;

        // 显示模态层
        case ACTION_TYPES.LAYOUT_DD_SHOW_MODAL:
            newState.isShowModal = true;
            break;

        // 隐藏模态层
        case ACTION_TYPES.LAYOUT_DD_HIDE_MODAL:
