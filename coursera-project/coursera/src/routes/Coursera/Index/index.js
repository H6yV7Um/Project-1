...
import Search from 'appComponents/Coursera/Search';
    ...
    render() {
        ...
        const columns = [
            {
                ...
                render : (text, record) => {
                    ...
                    {/*return <span> {record.courseraname} </span>*/}
                }
            },
            {
                title : `证书`,
                        ...
                        return  <div className={`${className}-preview`}>
                                    <div>
                                        <Preview
                                            ...
                                            coursera_key = {this.state.coursera_key}
                                            owonCourseraKey = {record.coursera_key}
            ...
            return(
                <div className={`${className}`}>
                    <div  className={`${className}-header`} ref={(dom1)=>this.dom1 = dom1}>
                        ...
                        <div onClick={()=>{browserHistory.push('/chart')}}>
        ...
        else
        {
            ...
            const  showManageDepartment = () =>{
                ...
                {
                    return <span className={`${className}-PC-count`}>
                                <a onClick={()=>{browserHistory.push('/management')}}>组织架构管理</a>
                                <a href='http://172.20.70.69:3005/download_coursera_excel' download='coursera_excel'>下载1</a>
                            </span>
                }
                else
                {
            ...
            return  <div className={`${className}-PC`} ref={(dom)=>this.dom = dom}>
                <div className='container'>
                    ...
                    <span className={`${className}-PC-count`}>
                                    <a onClick={()=>{browserHistory.push('/chart')}}>查看统计</a>
                                </span>
                    {showLatest()}
                    {showReset()}
                    ...
                    <Table
                        onRowClick={(record, index, event)=>{
                            if(this.state.index >100){
                                this.setState({...this.state,coursera_key: record.coursera_key,index: this.state.index-1})
                            }
                            else {
                                this.setState({...this.state,coursera_key: record.coursera_key,index: this.state.index-1})
                            }
