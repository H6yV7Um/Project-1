...
export default (state = initialState, action) => {
    ...
    {
         // 获取搜索列表
        case `REQUEST_${ACTION_TYPES.TRAIN_COURSERA_GET_SEARCH_LIST}`:
            if(!ismobile)
            {
                newState.itemList = []
            }
            ...
            // 重置列表
            break;
        case `FAIL_${ACTION_TYPES.TRAIN_COURSERA_GET_SEARCH_LIST}`:
            newState.fetchSearchList = false;
            break;
        case ACTION_TYPES.TRAIN_COURSERA_GET_SEARCH_LIST:
            newState.fetchSearchList = false
            ...
            break;
         // 获取列表
        case `REQUEST_${ACTION_TYPES.TRAIN_COURSERA_GET_CONRSERA_LIST}`:
            ...
            // 重置列表
            break;
        case `FAIL_${ACTION_TYPES.TRAIN_COURSERA_GET_CONRSERA_LIST}`:
            newState.fetchGetCourseraList = false;
            break;
        case ACTION_TYPES.TRAIN_COURSERA_GET_CONRSERA_LIST:
            newState.fetchGetCourseraList = false;
            ...
            break;
        case ACTION_TYPES.TRAIN_COURSERA_INDEX_GET_DEPARTMENT:
            newState.departments = action.data
            break;
         // 获取filter列表
        case `REQUEST_${ACTION_TYPES.TRAIN_COURSERA_FILTER}`:
            newState.fetchFilterList = true;
            newState.itemList = []
            // 重置列表
            break;
        case `FAIL_${ACTION_TYPES.TRAIN_COURSERA_FILTER}`:
            newState.fetchFilterList = false;
            break;
        case ACTION_TYPES.TRAIN_COURSERA_FILTER:
            newState.fetchFilterList = false
            ...
            break;
        //组件销毁时重置数据
        case ACTION_TYPES.TRAIN_COURSERA_INDEX_CLEAR:
                newState.itemList = []     
                newState.isSearch = false
                ...
                break;
         // 获取学校名称
        case `REQUEST_${ACTION_TYPES.TRAIN_COURSERA_INDEX_GET_SCHOOL}`:
            newState.fetchGetSchool = true;
            // 重置列表
            break;
        case `FAIL_${ACTION_TYPES.TRAIN_COURSERA_INDEX_GET_SCHOOL}`:
            newState.fetchGetSchool = false;
            break;
        case ACTION_TYPES.TRAIN_COURSERA_INDEX_GET_SCHOOL:
            newState.fetchGetSchool = false;
        ...
        // 判断是否进入页面或者返回到首页
        case ACTION_TYPES.TRAIN_COURSERA_GET_GO_BACK_TRAIN:
