...
export default (state = initialState, action) => {
    ...
    switch(action.type)
    {
        ...
        case `REQUEST_${ACTION_TYPES.TRAIN_COURSERA_PERSONAL_SEARCH_LIST}`:
            if(!ismobile)
            {
                newState.itemList = []
            }
            ...
            // 重置列表 
            break;
        case `FAIL_${ACTION_TYPES.TRAIN_COURSERA_PERSONAL_SEARCH_LIST}`:
            newState.fetchSearchList = false;
            break;
        case ACTION_TYPES.TRAIN_COURSERA_PERSONAL_SEARCH_LIST:
            newState.fetchSearchList = false
        ...
        case ACTION_TYPES.TRAIN_COURSERA_PERSONAL_CLEAR:
            newState.itemList = [];
            newState.searchPage = [];
