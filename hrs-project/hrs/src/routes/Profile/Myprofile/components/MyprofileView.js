...
class MyprofileView extends React.Component {
    ...
    async componentWillMount() {
        if(!Object.keys(this.props.data.memberData).length)
        {
            await this.props.getFieldsGroup()
            await this.props.getProfileTaxes()
            await this.props.getSocialSecurity()
            await this.props.getSalary()
            await this.props.getFund()
        }
    }
