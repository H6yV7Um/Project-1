...
class DepartmentsPickerItem extends Component {
    ...
    static propTypes =
        {
            // 微应用名
            agentName: PropTypes.oneOf(['show', 'recruit', 'train']).isRequired,
            // 标签名
            ...
            defaultDepartments: PropTypes.array,
    ...
    choose = () => {
        ...
        if (dd.os !== 'pc') {
            ...
            dd.biz.contact.departmentsPicker({
                ...
                appId: CONFIG.DD_GET_AGENT_ID(this.props.agentName),
    ...
    render () {
        ...
        let className = 'appComponentDingdingDepartmentsPickerItem'
            ...
            departmentsItem =
                <Item className={`${className}-departments`} extra={
                    this.isDefaultDepartments
                        ? null
                        : <div className={`${className}-clear`} onClick={() => { this.setValue([]) }}>
