...
class Ding extends Component {
    ...
    static propTypes =
        {
            // 设置执行Ding
            setRunDing: PropTypes.func.isRequired,
            // 是否Ding
            isDing: PropTypes.bool,
    ...
    render () {
        ...
        let className = 'appComponentDingdingDing'
        ...
        return (
            <div className={componentClassName} style={this.props.style}>
                <Item extra={
                    ...
                    <Icon className={`${className}-icon`} type={'thumb-tack'} />
                    <div className={`${className}-name`}>DING</div>
                </Item>
            </div>
        )
    }
