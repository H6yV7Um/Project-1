...
class Review extends Component {
    ...
    static propTypes = {
        ...
        // 取消转发
        closeForward        :   PropTypes.func,
        // 转发人列表  [User]
        forwardUsers        :   PropTypes.array,
        // 转发人最大显示人数
        forwardUsersLength  :   PropTypes.number,
        // 是否可点赞
        ...
        // 点赞
        openLike            :   PropTypes.func,
        // 取消点赞
        closeLike           :   PropTypes.func,
        // 点赞人列表  [User]
        likeUsers           :   PropTypes.array,
        // 点赞人最大显示人数
        likeUsersLength     :   PropTypes.number,
        // 是否可回复
        ...
        // 是否可取回复列表
        isGetReplies        :   PropTypes.bool,
        // 获取回复列表
        getReplies          :   PropTypes.func,
        // 是否正在获取回复列表
        isGettingReplies    :   PropTypes.bool,
        // 是否可删除
        isDelete            :   PropTypes.bool,
        // 删除
        delete              :   PropTypes.func,
        // 评论最大直接显示行数
        showLineNum         :   PropTypes.number
    }
