        ...
        if (this.testResult === 0) {
            ...
            if (isTest) {
                ...
                if (this.endCoordinate.y > this.startCoordinate.y && e.currentTarget.scrollTop <= 0) {
                    this.testResult = 2
                } else if (this.endCoordinate.y < this.startCoordinate.y &&
                    e.currentTarget.scrollHeight - e.currentTarget.clientHeight - e.currentTarget.scrollTop <= 0) {
                    // 往下滚动
                    this.testResult = 2
                }
            }
            ...
            <div
                ...
                onWheel={e => {
                    ...
                    if ((e.deltaY < 0 && e.currentTarget.scrollTop <= 0) ||
                        (e.deltaY > 0 && e.currentTarget.scrollHeight - e.currentTarget.clientHeight - e.currentTarget.scrollTop <= 0)) {
                        e.preventDefault()
                    }
                }}
            >
