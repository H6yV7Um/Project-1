...
class Show extends Component {
    ...
    static propTypes = {
        ...
        // 存在动画名
        existAnimateName    :   PropTypes.oneOf(['linear', 'swing', 'easeInQuad', 'easeOutQuad', 'easeInOutQuad',
            'easeInCubic', 'easeOutCubic', 'easeInOutCubic', 'easeInQuart', 'easeOutQuart', 'easeOutQuint',
            'easeInOutQuint', 'easeInExpo', 'easeOutSine', 'easeInOutSine', 'easeInCirc', 'easeOutCirc', 'easeInOutCirc',
            'easeInElastic', 'easeOutElastic', 'easeInOutElastic', 'easeInBack', 'easeOutBack', 'easeInOutBack',
            'easeInBounce', 'easeOutBounce', 'easeInOutBounce'
    ...
    existAnimatePositive = () => {
        if (this.status === 'show' && (this.props.existAnimateStyle || this.props.existAnimateScale !== 0)) {
            ...
            if (this.props.existAnimateStyle) {
                style = {
                    width : showStyle.width,
                    height : showStyle.height,
                    marginLeft : showStyle.marginLeft,
                    marginTop : showStyle.marginTop,
                    ...this.props.existAnimateStyle
                }
            ...
            $(this.domShow).finish()
                .animate(style, this.props.existAnimateDuration, this.props.existAnimateName, this.props.existAnimateIsBack ? this.existAnimateReverse : null)
        }
    }
