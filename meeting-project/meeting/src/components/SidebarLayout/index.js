...
class SidebarLayout extends Component {
    ...
    static propTypes = {
        ...
        // 左滑动时间
        leftDuration        :   PropTypes.number,
        // 左滑动动画
        leftAnimateName     :   PropTypes.oneOf(['linear', 'swing', 'easeInQuad', 'easeOutQuad', 'easeInOutQuad', 'easeInCubic', 'easeOutCubic', 'easeInOutCubic', 'easeInQuart',
        ...
        // 右滑动时间
        rightDuration       :   PropTypes.number,
        // 右滑动动画
        rightAnimateName    :   PropTypes.oneOf(['linear', 'swing', 'easeInQuad', 'easeOutQuad', 'easeInOutQuad',
        ...
        // 切换距离临界点
        changeDistance      :   PropTypes.number,
        /**
         * 事件:当界面改变时
         * @param page  当前页数
                ...
                >
                    ...
                    <div
                        ...
                        style={{
                            ...
                            display : this.state.middleBorderDisplay,
                            backgroundColor : `rgba(0, 0, 0, ${this.state.middleBorderOpacity * 0.4})`
                        }}
