...
class Grid extends Component {
    ...
    render()
    {
        ...
        let containerWidth = (this.props.width + marginLeft) * rowLength;
        ...
        this.props.itemList.map((v, k) => {
            ...
            itemList.push(
                <div
                    ...
                    key={k}
                    style={{marginLeft : k % rowLength == 0 ? 0 : this.props.rowNum == 1 && this.props.isOverflow ? this.props.minMargin : marginLeft}}
                >
                    {v}
                </div>
            );
