...
class Upload extends Component {
    ...
    static propTypes =
    {
        ...
        fileType            :   React.PropTypes.oneOf(['image', 'music', 'video', 'file']).isRequired,
    ...
    static defaultProps =
    {
        ...
        // 上传url
        uploadUrl           :   API.COMMON_UPLOAD_FILE,
        // 列表尺寸
    ...
    componentWillMount() {
        ...
        {
            this.fileExt = getFileAccepts(this.props.fileExt.join(',')).join(',');
        }
        else
        {
    ...
    render()
    {
        ...
        return(
            <div className={this.className} style={this.props.style ? this.props.style : {}}>
                {/*标签名*/}
